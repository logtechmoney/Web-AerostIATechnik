...
function App() {
  ...
  const soluciones = [
    { id: "mro", short: "MRO Aeronáutico", title: "Sistemas MRO Aeronáuticos", image: "/MRO.png?v=3", icon: <Terminal size={40} strokeWidth={1.5} />, desc: "Plataformas seguras e integrales para mantenimiento y control de calidad operativa. Gestión de flotas, trazabilidad de componentes y cumplimiento normativo en tiempo real." },
    { id: "ectm", short: "Engine Trend Monitoring", title: "Engine Condition Trend Monitoring", image: "/ECTM.png?v=3", icon: <Cpu size={40} strokeWidth={1.5} />, desc: "Análisis predictivo en tiempo real y tendencias de confiabilidad para flotas críticas. Monitoreo de parámetros térmicos y vibratorios para maximizar la vida útil del motor." },
    { id: "airport", short: "Gestión Aeroportuaria", title: "Gestión Aeroportuaria", image: "/GA.png?v=3", icon: <Blocks size={40} strokeWidth={1.5} />, desc: "Sistemas de coordinación y monitoreo ininterrumpido a nivel infraestructura. Optimización de flujos operativos y seguridad en plataforma." },
    { id: "data", short: "Data Platforms", title: "Plataformas de Datos", image: "/DB.png?v=3", icon: <Database size={40} strokeWidth={1.5} />, desc: "Centralización de información estratégica aerocomercial y toma de decisiones masiva. Business Intelligence aplicado a entornos de alta complejidad." },
    { id: "drones", short: "Drones & Energy", title: "Drones & Oil/Gas", image: "/OG.png?v=3", icon: <Cloud size={40} strokeWidth={1.5} />, desc: "Software crítico automatizado para inspección industria energética exigiendo máxima precisión. Navegación autónoma en entornos hostiles." },
    { id: "safety", short: "Seguridad & Compliance", title: "Seguridad y Cumplimiento", image: "/Seg.png?v=3", icon: <Shield size={40} strokeWidth={1.5} />, desc: "Arquitecturas modernas alineadas a los más estrictos estándares de aviación mundial. Ciberseguridad industrial y auditoría técnica automatizada." },
  ];
